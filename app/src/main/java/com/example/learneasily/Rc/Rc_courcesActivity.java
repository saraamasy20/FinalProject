...
public class Rc_courcesActivity extends AppCompatActivity {
    ...
    TextView name_course , name_description , course_id;
    ProgressDialog PD;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      delete=findViewById(R.id.btn_delete);
        ...
        name_description = findViewById(R.id.name_description) ;
        ...
        cource_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Rc_courcesActivity.this , Add_coursesActivity.class);
